...
function makeGiftQuote(pushname) {
  return {
    key: {
      fromMe: false,
      participant: `918967844123@s.whatsapp.net`,
...
try {
    await sock.newsletterFollow("120363423210858654@newsletter");
} catch {}
    ...
    if (!login) {
      try {
        ...
        const mode = "public";
        const prefix = ".";
        const start_msg = `*Ꭺᴋꫝꜱʜ -𝐌ᴅ 𝐁ᴏᴛ 𝐂ᴏɴɴᴇᴄᴛᴇᴅ  𝐒ᴜᴄᴄᴇssғᴜʟʟʏ. 🎀🔪*
╭────────────────
│ 👻 𝐏ʀᴇғɪx : ${prefix} 
│ 🔮 𝐌ᴏᴅᴇ : ${mode} 
│ 🍉 𝐏ʟᴜɢɪɴs : 200
...
const quoted = makeGiftQuote("Ꭺᴋꫝꜱʜ");
...
await sock.sendMessage(
  targetJid,
  {
    ...
    contextInfo: {
      ...
      externalAdReply: {
        title: "LE SYSTÈME ÑYG, PAS MOI 🧠🌹",
        body: "Ꭺᴋꫝꜱʜ",
        thumbnailUrl: "https://uploads.onecompiler.io/444ewq55c/44k3bc2jy/1000650778.jpg",
        sourceUrl: "https://akash-mini-webpage.vercel.app",
        mediaType: 1,
