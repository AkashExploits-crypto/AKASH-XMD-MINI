...
Module({
  ...
  try {
    ...
    if (!raw) {
      ...
      return message.send(
        `*𝐀ɴᴛɪ 𝐋ɪɴᴋ 𝐄ɴᴀʙʟᴇᴅ 𝐈ɴ 𝐓ʜɪs 𝐆ʀᴏᴜᴘ .✅*\n*• 𝐒ᴛᴀᴛᴜs:* ${isEnabled ? "✅ ON" : "❌ OFF"}\n*• 𝐌ᴏᴅᴇ:* ${mode.toUpperCase()}\n\n*𝐔ᴇs:*\n• .antilink on\n• .antilink off\n• .antilink kick\n• .antilink null\n• .antilink warn`
      );
    }
    ...
    if (raw === 'on') {
      ...
      return message.send(`✅ 𝐀ɴᴛɪʟɪɴᴋ 𝐇ᴀs 𝐁ᴇᴇɴ *𝐄ɴᴀʙʟᴇᴅ* 𝐅ᴏʀ 𝐓ʜɪs 𝐆ʀᴏᴜᴘ.\n*𝐀ction:*${hasMode.toUpperCase()}*`);
    }
